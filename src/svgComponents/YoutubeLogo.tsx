...
interface YoutubeLogoProps {
  fillColor?: string;
} // This will allow you to pass fill colors for specific paths

const YoutubeLogo: React.FC<
  YoutubeLogoProps & React.SVGProps<SVGSVGElement>
> = ({ fillColor = "black", ...props }) => {
  // State to track hover
  const [isHovered, setIsHovered] = useState(false);

  // Conditional fill color for hover effect
  const hoverFillColor = isHovered ? "#E71D36" : fillColor; // Change to blue on hover

  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      //   viewBox="0 0 374.81 155.98"
      viewBox="0 0 374.81 155.98"
      width="300" // Set the width you want (you can adjust this)
